...
Java_org_mariotaku_inetaddrjni_library_InetAddressUtils_getInetAddressType(JNIEnv *env, jclass type,
                                                                        jstring input_) {
...
Java_org_mariotaku_inetaddrjni_library_InetAddressUtils_getResolvedIPAddress(JNIEnv *env, jclass type,
                                                                          jstring host_,
                                                                          jstring address_) {
